 ...
 *              glob(SRC_ROOT . '/Docx/*.php'),
 *              glob(SRC_ROOT . '/Docx/Base/*.php'));
 *  }
    ...
    private function parse_use(array &$tokens, $t, &$i, $count)
    {
        ...
        do {
            ...
            if ($t[0] === T_USE) {
                ...
                $var_name = 'use_alias';
            } elseif (!in_array($t[0], [T_COMMENT, T_WHITESPACE], true)) {
                ${$var_name} .= $t[1];
            }
        } while ($i < $count);
